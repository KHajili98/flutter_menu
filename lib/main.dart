...
import 'package:flutter_menu_example/desktop_menu/src/appscreen.dart';

import 'desktop_menu/src/appscreen_model.dart';
import 'desktop_menu/src/contextmenu.dart';
import 'desktop_menu/src/contextmenu_widgets.dart';
import 'desktop_menu/src/menu_model.dart';
...
class _ScreenState extends State<Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: AppScreen(
        dekstopMenuBarHeight: 25,
        //!  SOL PANELDE MAUSUN SAGI KLIKLEYENDE ---------------------------------------
        masterContextMenu: ContextMenu(
          width: 150,
          height: 400,
          child: ContextMenuSliver(
            title: 'Sol hissenin sagi klikleyende',
            children: [
        ...
        //!  SAG PANELDE MAUSUN SAGI KLIKLEYENDE ---------------------------------------
        detailContextMenu: ContextMenu(
          width: 300,
          height: 300,
          child: ContextMenuSliver(
            title: 'SAG hissenin sagi klikleyende',
            children: [
        ...
        drawer: AppDrawer(
          defaultSmall: true, showOnDesktop: true,
  ...
  void _showPopupMenu(Offset offset) async {
    ...
    await showMenu(
      ...
      position: RelativeRect.fromSize(
          Rect.fromLTRB(left + 30, top, 0, 0), Size(left + 30, top)),
      items: [
        PopupMenuItem(
          value: 1,
          child: Row(
...
// NOTE: even you didnt select item this method will btmme called with null of value so you should call your call back with checking if value is not null
      ...
      child: Card(
          ...
          child: SizedBox(
            ...
            child: GestureDetector(
              ...
              child: Center(
                  child: Icon(icon,
                      size: 30, color: _enabled ? Colors.red : Colors.black54)),
            ),
          )),
    );
  }
